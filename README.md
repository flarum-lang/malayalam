...
This language pack contains Malayalam translations for Flarum (compatible with `2.0.0` or newer) and popular extensions. Full list of supported extensions is available below.
...
```console
composer require "flarum-lang/malayalam:@dev"
```
...
| Component | Status |
| --- | --- |
| [Core](https://github.com/flarum/flarum-core) | [![Translation status](https://weblate.rob006.net/widgets/flarum2/ml/core/svg-badge.svg)](https://weblate.rob006.net/projects/flarum2/core/ml/) |
